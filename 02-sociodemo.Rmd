...
language <- makePlotData("What was the first language you learned and still use (i.e., native language)?",
                         ...
                         levels = rep(list(c("Arabic", "Chinese", "Danish",
                                      ...
                                      times = 8),
                         labels = NULL,
                         labelOrder = c(9, 17, 7, 15, 22, 11, 19, 20, 14, 8, 13, 
                                        5, 2, 23, 10, 16, 3, 5, 18, 21, 12, 
                                        5, 1))
...
religion <- makePlotData("Do you belong to a religion or religious denomination?",
                         ...
                         labels = c("No religion", "Christian (not Catholic)",
                                    "Jewish", "Catholic", "Buddhist", "Muslim",
                                    "Other religion"),
                         labelOrder = 1:7,
                         groups = c(5, 4,
                                    2, 7,
...
ggplot(religion, aes(x = year, y = est, color = labels)) +
  geom_line(linewidth = 1.5) +
  geom_point(size = 2.25, color = "black") +
  theme_bw(13) +
  theme(panel.grid.minor = element_blank()) +
