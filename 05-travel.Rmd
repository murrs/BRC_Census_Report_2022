...
ggplot(nbvehicle[nbvehicle$year == 2022,], aes(x = labels, y = est)) +
  geom_bar(stat = "identity", fill = "#EA008B") +
  scale_y_continuous(labels = percent) +
  labs(x = "Number of people", y = "Burning Man participants (%)") +
  theme_bw() 
...
ggplot(minorInVehicle, aes(x = year, y = est, fill = labels, color = labels)) +
  ...
  guides(color = "none") +
  labs(x = "", y = "Burning Man participants (%)", color = "")
...
ggplot(mpg[mpg$year == 2022,], aes(x = mpg, weight = weights)) +
  ...
  geom_segment(x = mpg.means$mpg[mpg.means$year == 2022], 
             ...
             linewidth = 1.1) +
  annotate("text", x = 50, y = 0.0418, label = "Average miles per gallon to Black Rock City (18.9 MPG)") +
  theme_bw(13) +
...
ggplot(design22$variables, aes(x = miles2, weight = weights)) +
  ...
  annotate("text", x = 2750, y = 0.0005, label = "Average miles driven (1190.4 miles)") +
  theme_bw(13) +
...
ggplot(route, aes(x = labels, y = est, fill = as.factor(year))) +
  ...
  labs(x = "Route to Black Rock City", y = "Burning Man participants (%)", fill = "") +
  theme_bw() +
  coord_flip()
